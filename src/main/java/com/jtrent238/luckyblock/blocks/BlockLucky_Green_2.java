...
public class BlockLucky_Green_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Green_2";
	
	public BlockLucky_Green_2(Material material) {
		super(material);
