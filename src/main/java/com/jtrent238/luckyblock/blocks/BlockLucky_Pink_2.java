...
public class BlockLucky_Pink_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Pink_2";
	
	public BlockLucky_Pink_2(Material material) {
		super(material);
