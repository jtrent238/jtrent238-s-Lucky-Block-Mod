...
public class BlockLucky_Lime_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Lime_2";
	
	public BlockLucky_Lime_2(Material material) {
		super(material);
