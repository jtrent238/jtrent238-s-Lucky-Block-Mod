...
public class BlockLucky_Orange_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Orange_2";
	
	public BlockLucky_Orange_2(Material material) {
		super(material);
