...
public class BlockLucky_Grey_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Grey_2";
	
	public BlockLucky_Grey_2(Material material) {
		super(material);
