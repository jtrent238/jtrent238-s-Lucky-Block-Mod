...
public class BlockLucky_LightBlue_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_LightBlue_2";
	
	public BlockLucky_LightBlue_2(Material material) {
		super(material);
