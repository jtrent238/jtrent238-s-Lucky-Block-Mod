...
public class BlockLucky_Cyan_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Cyan_2";
	
	public BlockLucky_Cyan_2(Material material) {
		super(material);
