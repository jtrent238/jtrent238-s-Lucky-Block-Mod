...
public class BlockLucky_Blue_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Blue_2";
	
	public BlockLucky_Blue_2(Material material) {
		super(material);
