...
public class BlockLucky_Black_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Black_2";
	
	public BlockLucky_Black_2(Material material) {
		super(material);
