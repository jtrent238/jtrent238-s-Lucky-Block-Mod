...
public class BlockLucky_Purple_2 extends mod.lucky.block.BlockLuckyBlock {

	private String blockName = "BlockLucky_Purple_2";
	
	public BlockLucky_Purple_2(Material material) {
		super(material);
